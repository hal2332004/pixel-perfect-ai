...
const MESSAGES = {
  vi: {
    ...
    overview: {
      ...
      rows: { bicubic: "ESPCNN", oursOptimized: "IMDN" },
    ...
    realtime: {
      ...
      start: "Start",
      stop: "Stop",
      inputRtsp: "RTSP input",
      outputRtsp: "RTSP output",
      cameraFps: "FPS camera",
      modelFps: "FPS model",
      copy: "Copy",
      open: "Open",
      rtspHint: "Trình duyệt thường không phát được RTSP; hãy mở bằng VLC/ffplay.",
      started: "Đã start stream",
      stopped: "Đã stop stream",
      startFailed: "Start stream thất bại",
      stopFailed: "Stop stream thất bại",
      requestTimeout: "Request bị timeout",
      missingApiUrl: "Thiếu URL API",
      missingApiUrlHint: "Hãy cấu hình VITE_SR_API_URL hoặc VITE_HEALTH_API_URL trong frontend .env",
      missingApiKey: "Thiếu API key",
      missingApiKeyHint: "Hãy cấu hình VITE_SR_API_KEY hoặc VITE_HEALTH_API_KEY trong frontend .env",
      copied: "Đã copy",
  ...
  en: {
    ...
    realtime: {
      ...
      copy: "Copy",
      open: "Open",
      rtspHint: "Browsers usually cannot play RTSP; open with VLC/ffplay.",
      ...
      missingApiUrlHint: "Set VITE_SR_API_URL or VITE_HEALTH_API_URL in the frontend .env",
      missingApiKey: "Missing API key",
      missingApiKeyHint: "Set VITE_SR_API_KEY or VITE_HEALTH_API_KEY in the frontend .env",
      copied: "Copied",
  ...
  ja: {
    ...
    realtime: {
      ...
      copy: "Copy",
      open: "Open",
      rtspHint: "ブラウザは通常RTSPを再生できません。VLC/ffplayで開いてください。",
      started: "配信を開始しました",
      stopped: "配信を停止しました",
      startFailed: "配信の開始に失敗しました",
      stopFailed: "配信の停止に失敗しました",
      requestTimeout: "リクエストがタイムアウトしました",
      missingApiUrl: "API URLが未設定です",
      missingApiUrlHint: "frontendの.envで VITE_SR_API_URL または VITE_HEALTH_API_URL を設定してください",
      missingApiKey: "API keyが未設定です",
      missingApiKeyHint: "frontendの.envで VITE_SR_API_KEY または VITE_HEALTH_API_KEY を設定してください",
      copied: "コピーしました",
